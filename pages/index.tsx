...
const Home = ({ collections }: Props) => {
  return (
    <div className='max-w-10xl mx-auto flex flex-col min-h-screen pt-5 pb-20 px-2 md:px-10 2xl:p-0 ' >
      <Head>
      ...
      <h1 className='mb-14 text-4xl font-extralight text-white' >The <span className='font-extrabold'>OCTULUS</span></h1>
        ...
        <div className='grid lg:grid-cols-7 w-fit sm:auto-cols-auto md:space-x-4 md:grid-cols-4 xl:grid-cols-7'>
